<template>
  <div class="flex flex-col flex-1">
    ...
    <div class="flex flex-col py-12 items-center">
      ...
      <AnimatedPlaceholder class="max-h-[300px] h-[100px] w-full mb-12" />
      <AnimatedPlaceholder class="max-h-[300px] h-[75px] w-full mb-8" />
    </div>
    <!-- Hourly -->
    <div class="flex flex-col py-12 items-center">
      <AnimatedPlaceholder class="max-w-screen-md h-[100px] w-full" />
    </div>
    <!-- Weekly -->
    <div class="flex flex-col py-12 items-center">
      <AnimatedPlaceholder class="max-w-screen-md h-[100px] w-full" />
